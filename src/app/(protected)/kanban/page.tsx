  ...
  return (
    <main className="flex-1 flex flex-col lg:flex-row gap-y-4 gap-x-4">
      <ul className="flex-1 flex flex-col gap-y-2 ">
        ...
        {dockitts?.filter((item) => item.status === "Backlog").length === 0 ? (
              ...
              >
                ...
                <div className="flex-1 card bg-base-100 max-w-full shadow-xl">
                  <div className="card-body relative">
                    {
                      dockitt.tag && <div className="absolute top-2 right-4 badge badge-outline">{dockitt.tag}</div>
                    }
                    ...
                    <div className="flex items-center">
                      <p>
                        Priority: 
                        {
                          dockitt.priority === "Critical" ? <span className="uppercase font-bold text-red-500"> {dockitt.priority}</span> : <span className="italic font-bold"> {dockitt.priority}</span>
                        }
                      </p>
                    <UpdateStatusBtns
                      btnGroup={1}
